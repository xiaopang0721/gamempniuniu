...
module gamempniuniu.page{
	export class MpniuniuLosePage extends game.gui.base.Page {
		private _viewUI: ui.nqp.game_ui.mpniuniu.JieSuan_2UI;
		...
		// 页面初始化函数
		protected init(): void {
			this._viewUI = this.createView('game_ui.mpniuniu.JieSuan_2UI');
